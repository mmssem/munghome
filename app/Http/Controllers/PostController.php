...
class PostController extends Controller
{
    public function index()
    {
        ...
        ${"arr_$arr_count"} = array(
            ...
            array(
                "2022-07-01", "2.0", "학부모 상담 예약 시스템 (2학기 운영 시작)",
            ...
            array(
                "2022-07-09", "", "(새시스템용)분반(4.1)+일일교육(3.1)+예약(2.2)통합프로그램(이번에는 예약시스템만 업데이트됨",
            ...
            array(
                "2021-08-24", "1.0", "웹을 이용한 외워쓰기(받아쓰기) 1학년 2학기용, 2학년 1,2학기용",
        ...
        ${"arr_$arr_count"} = array(
            ...
            array(
                "2021-08-20", "3.5", "가로카메라앱(horizontal camera)-미러링, 무선실물화상기 대용",
        ...
        ${"arr_$arr_count"} = array(
            ...
            array(
                "2022-01-28", "2.0", "NEIS 접속 도우미 - 엣지(Edge)용, EVPN 접속 가능",
            ...
            array(
                "2022-04-01", "3.1", "나이스 입력 도우미 통합본-탭5번 추가",
            ...
            array(
                "2022-01-27", "1.0", "나이스 초등 신입생(1학년) 주소 변환 프로그램",
            ...
            array(
                "2021-06-24", "3.0", "자가진단 자동로그인 프로그램",
        ...
        ${"arr_$arr_count"} = array(
            ...
            array(
                "2022-02-26", "1.0", "항상 위 (AlwaysOnTop, 메모장, 기타 어떤 프로그램이든...) 종합판",
            ...
            array(
                "2022-01-17", "1.0", "윈도우 자체에서 메모장 항상 위 구현",
        ...
        ${"arr_$arr_count"} = array(
            ...
            array(
                "2022-07-05", "1.0", "BarQrNfcToPc 안드로이드 앱",
            ...
            array(
                "2022-07-05", "2.0", "BarQrNfcToPc 윈도우용 프로그램",
            ...
            array(
                "2020-09-07", "2.0", "멍 QR 생성기 v2.0(인디스쿨 로그인 필수)",
            ...
            array(
                "2021-08-10", "1.0", "클456엑셀 프로그램(매크로 파일)",
        ...
        ${"arr_$arr_count"} = array(
            ...
            array(
                "2021-10-24", "1.0", "WiFi QR 생성기 프로그램",
            ...
            array(
                "2021-10-24", "1.0", "Easy WiFi Connector 앱 (using QR)",
            ...
            array(
                "2021-10-31", "1.0", "Easy WiFi Connector 프로그램 (using QR)",
            ...
            array(
                "2021-04-03", "1.1", "Scoman (기자재 관리 프로그램)",
            ...
            array(
                "2021-01-28", "1.0", "컴퓨터정보(이름, 작업그룹, 아이피 등..) 수정 프로그램",
